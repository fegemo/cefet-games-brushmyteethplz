 ...
 */
public class FirebaseRanking extends Ranking {

    private final Firebase firebase;
    
    public FirebaseRanking() {
    ...
    public final void readScores() {
        ...
        firebase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(FirebaseError firebaseError) {
                Gdx.app.error("FirebaseRanking", "Não foi possível ler do "
                        + "Firebase: " + firebaseError.getCode());
            }
        });
    }
     ...
     */
    @Override
    public void writeScore(String nickname, final int gamesPlayed) {
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(FirebaseError firebaseError) {
                Gdx.app.error("FirebaseRanking", "Não foi possível escrever "
                        + "a pontuação: " + firebaseError.getCode());
            }
        });
    }
}
